...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('translations')->group(function() {
        ...
        Route::get('/{translation}', [TranslationController::class, 'show'])->name('translations.show');
        Route::get('/{translation}/edit', [TranslationController::class, 'edit'])->name('translations.edit');
